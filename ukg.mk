...
# name
PRODUCT_RELEASE_NAME := SPRGS3

# device
$(call inherit-product-if-exists, device/samsung/d2spr/full_d2spr.mk)
...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.d2spr.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="d2spr-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/d2spr:4.2.2/JDQ39/573038:user/release-keys"
